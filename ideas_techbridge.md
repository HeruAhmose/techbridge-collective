...
## Selected Approach: "The Bridge" — Narrative Journey Design
...
4. Progressive disclosure — don't overwhelm, unfold

**Color Philosophy**: Forest green (#1B4332) as foundation — trust, growth, stability. Gold (#C9A227) as accent — warmth, value, hope. Cream (#FDF8F0) as canvas — approachable, not clinical. Charcoal (#2D3436) for text — readable, grounded.
...
**Interaction Philosophy**: Scroll IS the interaction. Each section triggers on viewport entry. Story cards expand on hover/tap. The Get Help form feels like arriving at the other side of the bridge.

**Animation**: GSAP ScrollTrigger drives the narrative. Sections fade-slide from alternating sides. Bridge cables draw with SVG path animation. Numbers count up on intersection. Parallax layers at 3 depths.

**Typography System**: Fraunces (display, serif, warm) + Inter (body, clean) + JetBrains Mono (data/stats). Fraunces brings editorial warmth; Inter keeps body text crisp.
