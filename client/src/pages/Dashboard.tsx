    ...
    <div className="flex flex-col gap-3">
      {data.map(d => (
        <div key={d.label} className="flex items-center gap-3">
          ...
          <span className="text-xs font-mono w-12 shrink-0 text-glow-gold">
            {d.value}
          </span>
        </div>
      ))}
  ...
  return (
    <div style={{ background: "var(--tb-forest)", color: "var(--tb-cream)" }}>
      <div className="container pt-28 pb-16">
        ...
        <div
          className="mb-6 glass-card px-5 py-4 flex items-center gap-3"
        ...
        >
          ...
          <div>
            <p className="text-sm font-display font-bold text-glow-gold">
              Simulated Dashboard
            </p>
            <p
              className="text-xs"
            ...
            >
              ...
              Live data will populate once TechMinutes® tracking goes live at
              partner sites.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          <div>
            <p className="text-sm font-mono tracking-widest uppercase mb-2 text-glow-gold">
              TechMinutes® Dashboard
            </p>
            <h1 className="font-display text-3xl md:text-4xl font-bold">
              Impact Command <span className="text-glow-teal">Center</span>
            </h1>
          </div>
          <div
            className="holo-badge flex items-center gap-2"
            style={{ color: "#00D4AA" }}
          >
            <span
        ...
        <div className="flex gap-1 mb-8 overflow-x-auto pb-2">
          {TABS.map(t => (
            <button
              ...
              style={{
                background:
                  tab === t.id ? "rgba(232, 185, 49, 0.12)" : "transparent",
                color: tab === t.id ? "#E8B931" : "rgba(253, 248, 240, 0.5)",
                border:
                  tab === t.id
                    ? "1px solid rgba(232, 185, 49, 0.3)"
                    : "1px solid transparent",
                textShadow:
                  tab === t.id ? "0 0 10px rgba(232, 185, 49, 0.3)" : "none",
              }}
            >
              <span>{t.icon}</span>
              <span>{t.label}</span>
          ...
          >
              ...
              <div className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="glass-card p-6">
                    <h3 className="font-display text-lg font-bold mb-4 text-glow-gold">
                      Issue Categories
                    </h3>
                    <BarChart
                      ...
                      <tbody>
                        {sessions.slice(0, 5).map(s => (
                          <tr
                            ...
                            style={{
                              borderBottom:
                                "1px solid rgba(253, 248, 240, 0.04)",
                            }}
                          >
                            <td className="py-2 px-3 font-mono text-xs text-glow-gold">
                              {s.id}
                            </td>
            ...
            {tab === "categories" && (
              <div className="space-y-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {categories.map(c => (
                    <motion.div
                      ...
                      whileHover={{ y: -6, boxShadow: `0 0 25px ${c.color}22` }}
                    ...
                    >
                      ...
                      <p
                        ...
                        style={{ color: "rgba(253, 248, 240, 0.45)" }}
                      >
                        {c.minutes.toLocaleString()} minutes
                      </p>
                    </motion.div>
                  ))}
                </div>
                ...
                <div className="glass-card p-6">
                  <h3 className="font-display text-lg font-bold mb-6 text-glow-gold">
                  ...
                  <div className="flex h-10 rounded-full overflow-hidden mb-4">
                    {categories.map(c => (
                      ...
                      >
                        {c.pct > 15 && (
                          <span style={{ color: "var(--tb-forest)" }}>
                            {c.pct}%
                          </span>
                        )}
                      </motion.div>
              ...
              <div className="space-y-6">
                <div className="glass-card p-6">
                  ...
                  <div className="flex items-end gap-2 h-48">
                    {trends.map((t, i) => (
                      ...
                      >
                        <span className="text-xs font-mono text-glow-gold">
                          {t.minutes}
                        </span>
                        <motion.div
                          ...
                          style={{
                            background:
                              "linear-gradient(to top, rgba(0, 212, 170, 0.6), #E8B931)",
                          }}
                          initial={{ height: 0 }}
                          animate={{
                            height: `${(t.minutes / Math.max(...trends.map(t => t.minutes))) * 160}px`,
                          }}
                    ...
                    {trends.map((t, i) => (
                      ...
                      >
                        ...
                        <motion.div
                          ...
                          initial={{ height: 0 }}
                          animate={{
                            height: `${(t.sessions / Math.max(...trends.map(t => t.sessions))) * 120}px`,
                          }}
                          transition={{ duration: 0.8, delay: i * 0.1 }}
                        />
                        <span
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <Stat
                    label="Peak Week"
                    value="Week 8"
                    sub="Highest activity recorded"
                  />
                  <Stat
                    label="Avg Weekly Minutes"
                    value={Math.round(
                      trends.reduce((s, t) => s + t.minutes, 0) / trends.length
                    )}
                    color="#00D4AA"
                    sub="Across all hubs"
                  />
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <Stat
                    label="Follow-up"
                    value={
                      sessions.filter(s => s.status === "follow-up").length
                    }
                  />
                  <Stat
                    label="In Progress"
                      ...
                      <thead>
                        <tr style={{ background: "rgba(232, 185, 49, 0.06)" }}>
                          {[
                            ...
                            <th
                              key={h}
                              className="text-left py-3 px-4 font-mono text-xs text-glow-gold"
                            >
                              {h}
                            </th>
                          ))}
                          ...
                          <motion.tr
                            ...
                            style={{
                              ...
                              background:
                                i % 2 === 0
                                  ? "transparent"
                                  : "rgba(253, 248, 240, 0.02)",
                            }}
                          >
                            <td className="py-3 px-4 font-mono text-xs text-glow-gold">
                              {s.id}
                            </td>
            ...
            {tab === "hk" && (
              <div className="space-y-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <Stat
                    label="Avg Response"
                    value={hkData.avgResponseTime}
                    color="#00D4AA"
                  />
                  <Stat
                    label="Satisfaction"
                    value={hkData.satisfaction}
                    suffix="%"
                    color="#00D4AA"
                  />
                  <Stat
                    label="Escalation Rate"
                    value={hkData.escalationRate}
                    suffix="%"
                    color="#C4704B"
                  />
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="glass-card p-6">
                    ...
                    <BarChart
                      data={hkData.topTopics.map(t => ({
                        label: t.topic.split(" ").slice(0, 2).join(" "),
                        value: t.count,
                        color: "#00D4AA",
                      }))}
                  ...
                  <div className="glass-card p-6">
                    ...
                    <div className="space-y-4">
                      {[
                        {
                          label: "Self-Resolved",
                          value: 100 - hkData.escalationRate,
                          color: "#00D4AA",
                        },
                        {
                          label: "Escalated to Navigator",
                          value: hkData.escalationRate,
                          color: "#C4704B",
                        },
                        {
                    ...
                    >
                      ...
                      >
                        "H.K. handles {100 - hkData.escalationRate}% of queries
                        independently, freeing Digital Navigators to focus on
                ...
                <div className="glass-card p-6">
                  ...
                  <p
                    ...
                    style={{ color: "rgba(253, 248, 240, 0.5)" }}
                  >
                    Click the bridge icon in the bottom-right corner to chat
                    with H.K. directly. Available 24/7.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span
                        key={q}
                        className="px-3 py-1.5 rounded-full text-xs font-mono cursor-pointer transition-all duration-300 hover:scale-105"
                        style={{
