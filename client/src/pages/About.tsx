...
function CircuitBg({ opacity = 0.05 }: { opacity?: number }) {
  return (
    ...
    >
      ...
      >
        <path
          d="M0 150 H250 V250 H450 V150 H650 V350 H800"
          stroke="#E8B931"
          strokeWidth="1"
          fill="none"
          opacity="0.4"
        />
        <path
          d="M0 450 H200 V300 H500 V450 H800"
          stroke="#00D4AA"
          strokeWidth="1"
          fill="none"
          opacity="0.3"
      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden">
        ...
        <div className="container relative z-10 pt-32 pb-20">
          ...
          >
            ...
            >
              TechBridge Collective exists because the digital divide isn't
              about devices — it's about access, dignity, and the human
              connection that makes technology useful.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <Reveal direction="right">
              <div>
                ...
                <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">
                  Horace <span className="text-glow-gold">King</span>
                </h2>
                <p
                  className="text-base mb-4 leading-relaxed"
                  style={{ color: "rgba(253, 248, 240, 0.75)" }}
                >
                  Born into slavery, Horace King became the most celebrated
                  bridge builder in the American South. He designed and
                  constructed bridges that connected communities separated by
                  rivers, geography, and circumstance.
                </p>
                <p
                  className="text-base mb-4 leading-relaxed"
                  style={{ color: "rgba(253, 248, 240, 0.75)" }}
                ...
                <div className="glass-card flex items-center gap-3 p-4 mt-6">
                  <img
                    ...
                    style={{
                      ...
                      boxShadow: "0 0 12px rgba(232, 185, 49, 0.3)",
                    }}
                  />
                  <div>
                    <p
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              >
                ...
                — our comprehensive operational document. Every section is named
                after a part of a bridge.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                num: "1",
                name: "The Crossing",
                focus: "Identity, values, brand voice, code of conduct",
                icon: "🧭",
              },
              {
                num: "2",
                name: "The Structure",
                focus: "Three pillars, partnership model, 60-day launch",
                icon: "🏗️",
              },
              {
                num: "3",
                name: "The Load",
                focus: "Budget, payroll, unit economics",
                icon: "⚖️",
              },
              {
                num: "4",
                name: "The Approach",
                focus: "Outreach rules, cadence, subject lines",
                icon: "📨",
              },
              {
                num: "5",
                name: "The Cables",
                focus: "Navigator training, session protocol, escalation",
                icon: "🔗",
              },
              {
                num: "6",
                name: "The Deck",
                focus: "Production stack, H.K. architecture, security",
                icon: "💻",
              },
              {
                num: "7",
                name: "The Abutments",
                focus: "Grant targets, local pipeline, growth roadmap",
                icon: "📈",
              },
              {
                num: "8",
                name: "The Foundation",
                focus: "Risk management, what-if scenarios, lean mode",
                icon: "🛡️",
              },
              {
                num: "9",
                name: "The Elevation",
                focus: "MBA case study — PESTEL, Porter's, SWOT",
                icon: "🎓",
              },
            ].map((s, i) => (
        ...
        <div className="container relative z-10">
          <Reveal>
            <div className="text-center mb-12">
              <h2 className="font-display text-3xl md:text-4xl font-bold">
                What Makes Us <span className="text-glow-gold">Different</span>
              </h2>
            </div>
          </Reveal>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              {
                title: "Human-First, AI-Augmented",
                desc: "We don't replace human connection with technology. We use AI to extend the reach of our human Navigators.",
                icon: "🤝",
                accent: "#00D4AA",
              },
              {
                title: "Embedded in Community",
                desc: "We go where people already are — libraries, churches, community centers. We don't ask people to come to us.",
                icon: "🏘️",
                accent: "#E8B931",
              },
              {
                title: "Measurable Impact",
                desc: "TechMinutes® gives every partner and funder auditable, non-PII data that proves community impact.",
                icon: "📊",
                accent: "#00D4AA",
              },
            ].map((item, i) => (
        ...
        <div className="container relative z-10">
          <Reveal direction="right">
            <div className="max-w-xl ml-auto text-right">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">
                Digital <span className="text-glow-teal">Navigators</span>
              </h2>
              <p
                className="text-base mb-4 leading-relaxed"
                style={{ color: "rgba(253, 248, 240, 0.85)" }}
              >
                Paid community members — not volunteers. Background-checked,
                trained, culturally competent, and bilingual when needed. They
                deliver 1-on-1 tech help sessions, triage digital crises, teach
                digital skills through guided practice, and log every session in
                TechMinutes®.
              </p>
            </div>
          </Reveal>
        ...
        <div className="container relative z-10">
          <Reveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">
                How We're <span className="text-glow-gold">Funded</span>
              </h2>
              <p
                className="text-base mb-8"
                style={{ color: "rgba(253, 248, 240, 0.65)", lineHeight: 1.8 }}
              >
                TechBridge operates through a blended funding model: government
                digital equity grants, philanthropic partnerships, and earned
                revenue from TechMinutes® reporting services.
              </p>
          ...
          <Reveal>
            <div className="text-center max-w-2xl mx-auto">
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
                Join the <span className="text-glow-gold">bridge</span>.
              </h2>
              <p
                className="text-base mb-8"
                style={{ color: "rgba(253, 248, 240, 0.6)" }}
              >
                Whether you need help, want to host a hub, or want to fund
                digital equity — there's a place for you.
              </p>
