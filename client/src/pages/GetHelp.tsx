...
const STORIES = [
  {
    ...
    accent: "#00D4AA",
    detail:
      "Maria came in during her lunch break. Her daughter's school switched to a new portal, and the password reset emails weren't arriving. In 18 minutes, a Digital Navigator helped her regain access, set up a backup email, and bookmarked the portal on her phone. Her daughter's grades were due that week.",
  },
  {
    name: "James",
    ...
    accent: "#E8B931",
    detail:
      "James, a veteran, had been trying to complete a federal job application for three days. The form kept timing out. A Digital Navigator sat beside him, helped him pre-fill answers in a document first, then guided him through the submission in one session. He got the interview.",
  },
  {
    name: "Dorothy",
    ...
    accent: "#C4704B",
    detail:
      "Dorothy, 74, had never used video calling. Her doctor's office moved to telehealth-only for follow-ups. A Digital Navigator helped her download the app, test her camera and microphone, and practice joining a call. She made her appointment that afternoon.",
  },
  {
    name: "Carlos",
    ...
    accent: "#E8B931",
    detail:
      "Carlos needed to upload proof of income for a housing application. The file was too large, the format was wrong, and the deadline was tomorrow. A Digital Navigator helped him resize the document, convert it to PDF, and submit it. His application went through.",
  },
  {
    name: "Keisha",
    ...
    accent: "#00D4AA",
    detail:
      "Keisha's FAFSA was flagged for verification. She didn't understand the IRS Data Retrieval Tool. A Digital Navigator walked her through every step, helped her link her tax information, and submitted the verification. She didn't lose her financial aid.",
  },
];
...
const PILLARS = [
  {
    ...
    description:
      "Walk-in and scheduled 1:1 sessions with trained, paid Digital Navigators. No volunteer churn. A consistent weekly presence residents rely on.",
    icon: "🤝",
    accent: "#00D4AA",
  },
  {
  ...
  },
  {
    ...
    description:
      "Monthly non-PII summary: minutes delivered, issue categories, demand patterns, and recommendations. Proof partners can use.",
    icon: "📊",
    accent: "#C4704B",
  },
];
...
const TIMELINE = [
  {
    day: "Day 1",
    label: "15-min call",
    description: "A quick conversation to see if we're a fit.",
  },
  {
    day: "Days 1–30",
    label: "Setup + Training",
    description: "We handle onboarding, navigator training, and materials.",
  },
  {
    day: "Days 30–45",
    label: "Hub Hours Live",
    description: "Weekly sessions begin. Residents start walking in.",
  },
  {
    day: "Day 60",
    label: "First Report",
    description: "Your first TechMinutes® impact report lands.",
  },
];
...
const DOMAINS = [
  ...
  },
  {
    ...
    title: "Workforce",
    sdg: "SDG 8",
    examples: "Job applications, resume uploads, hiring portals, VA benefits",
    accent: "#E8B931",
  },
  {
    icon: "🏥",
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <path
          d="M0 300 H150 V400 H350 V300 H550 V500 H800"
          stroke="url(#cg)"
          strokeWidth="1"
          fill="none"
          opacity="0.3"
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(10,31,20,0.65) 0%, rgba(10,31,20,0.8) 50%, rgba(10,31,20,0.95) 100%)",
            }}
          />
        </div>
        ...
        <div className="container relative z-10 pt-32 pb-20">
          ...
          >
            ...
            <p
              className="text-xl md:text-2xl leading-relaxed mb-6 max-w-2xl"
              style={{ color: "rgba(253, 248, 240, 0.75)" }}
            >
              The forms are online. What's missing is the person who sits down
            ...
            >
              Named for Horace King (1807–1885), who built bridges connecting
          ...
          >
            ...
            <a
              href="#stories"
              className="tb-btn tb-btn-ghost !text-base !px-8 !py-4"
              onClick={() => tbSoundEngine.play("nav_click")}
            >
              See How It Works
            </a>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
              <div>
                ...
                <p
                  ...
                  style={{ color: "rgba(253, 248, 240, 0.75)" }}
                >
                  A mother locked out of her child's school portal. A veteran
                  whose job application timed out. A senior who needs telehealth
          ...
          <Reveal>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {[
                ...
                {
                  value: 4,
                  label: "Issue categories tracked",
                  suffix: "",
                  color: "#00D4AA",
                },
                {
                ...
                {
                  value: 60,
                  label: "Days to first impact report",
                  suffix: "",
                  color: "#00D4AA",
                },
              ].map(stat => (
                ...
                >
                  ...
                  <div
                    className="text-xs font-mono mt-2 uppercase tracking-wider"
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-3xl md:text-5xl font-bold mb-4">
                ...
                <span className="text-glow-gold">Everything</span>
              </h2>
              <p
              ...
              >
                <motion.div
                  ...
                  onClick={() => {
                    ...
                    tbSoundEngine.play(
                      expandedStory === i ? "story_close" : "story_reveal"
                    );
                  }}
                >
                  <div className="flex items-start gap-4 p-6 pb-3">
                    ...
                    <div className="text-right shrink-0">
                      <span className="font-display text-2xl font-bold text-glow-gold">
                        {story.duration}
                      </span>
                      <p
                        className="text-xs"
                      ...
                      >
                        <div className="px-6 pb-6 pt-2">
                          ...
                          <p
                            ...
                            style={{ color: "rgba(232, 185, 49, 0.45)" }}
                          >
                            The resident sees one visit. The funder sees
                            systemic change.
                          </p>
                        </div>
                      </motion.div>
                  ...
                  <div className="px-6 pb-4 flex items-center gap-2">
                    ...
                    <span className="text-xs" style={{ color: story.accent }}>
                      {expandedStory === i ? "Close" : "Read the full story"}
                    </span>
                  </div>
                </motion.div>
              </Reveal>
        ...
        <div className="container relative z-10">
          <Reveal>
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-3xl md:text-5xl font-bold mb-4">
                Three Pillars of <span className="text-glow-gold">Support</span>
              </h2>
              <p
                className="text-base max-w-2xl mx-auto"
                style={{ color: "rgba(253, 248, 240, 0.55)" }}
              >
                ...
                deterministic triage between visits, and measurable impact every
                month.
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {PILLARS.map((pillar, i) => (
              <Reveal key={pillar.number} delay={i * 0.15} direction="scale">
                ...
                >
                  <div
                    className="font-display text-[100px] font-bold absolute -top-4 -right-2 select-none leading-none"
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <Reveal direction="left">
              <div>
                ...
                <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">
                  Meet <span className="text-glow-gold">H.K.</span> — Your 24/7
                  Guide
                </h2>
                <p
            ...
            <Reveal direction="right">
              <div className="relative">
                ...
                <img
                  ...
                  style={{
                    boxShadow:
                      "0 20px 60px rgba(0,0,0,0.4), 0 0 40px rgba(232, 185, 49, 0.1)",
                    animation: "glowPulse 4s ease-in-out infinite",
                  }}
                />
                <div
                  className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 px-5 py-3 rounded-xl font-display font-bold glass-card"
                  style={{
                    color: "#00D4AA",
        ...
        <div className="container relative z-10">
          <Reveal>
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-3xl md:text-5xl font-bold mb-4">
                Four Domains of <span className="text-glow-teal">Need</span>
              </h2>
              <p
                className="text-base max-w-2xl mx-auto"
                style={{ color: "rgba(253, 248, 240, 0.55)" }}
              >
                Every help desk interaction maps to one of four issue categories
                — giving partners clear data on what their community needs most.
              </p>
            </div>
          </Reveal>
        ...
        <div className="container relative z-10">
          <Reveal>
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-3xl md:text-5xl font-bold mb-4">
                60 Days to First <span className="text-glow-gold">Impact</span>
              </h2>
              <p
                className="text-base max-w-xl mx-auto"
                style={{ color: "rgba(253, 248, 240, 0.55)" }}
              >
                From first conversation to first impact report — here's how the
                bridge gets built.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="text-center mb-16">
              <h2 className="font-display text-3xl md:text-4xl font-bold">
                The <span className="text-glow-gold">Partnership</span>
              </h2>
              <p
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Reveal direction="right">
              ...
              >
                ...
                <p className="text-xs font-mono mb-6 text-glow-gold">
                  high-value
                </p>
                {[
                  {
                    text: "End-to-end staffing",
                    sub: "Paid Navigators. Zero workload.",
                  },
                  {
                    text: "Monthly TechMinutes® report",
                    sub: "Partner-ready data.",
                  },
                  {
                    text: "Issue-category intelligence",
                    sub: "What residents struggle with.",
                  },
                  {
                    text: "Consistent weekly presence",
                    sub: "Service neighbors talk about.",
                  },
                  {
                    text: "Story-ready narratives",
                    sub: "For funders & leadership.",
                  },
                ].map((item, i) => (
                  <div key={i} className="flex items-start gap-3 mb-4">
                    <div
            ...
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="font-display text-3xl md:text-5xl font-bold mb-4">
                  ...
                  <span className="text-glow-gold">Fit</span>
                </h2>
                <p
                  className="text-base"
                  style={{ color: "rgba(253, 248, 240, 0.55)" }}
                ...
                {!formSubmitted ? (
                  ...
                  >
                    <div className="flex flex-col gap-6">
                        ...
                        <input
                          ...
                          onFocus={e => {
                            ...
                            e.target.style.boxShadow =
                              "0 0 15px rgba(232, 185, 49, 0.1)";
                            tbSoundEngine.play("form_focus");
                          }}
                          onBlur={e => {
                            e.target.style.borderColor =
                      ...
                      <motion.button
                        type="submit"
                        className="w-full tb-btn tb-btn-primary !py-4 !text-lg justify-center"
                      ...
                      >
                        No cost. No sign-up. No data collected beyond what you
                        share here.
                      </p>
                    </div>
                  </motion.form>
                  ...
                  >
                    ...
                    <a
                      ...
                      className="tb-btn tb-btn-primary !px-8 !py-3"
                    >
