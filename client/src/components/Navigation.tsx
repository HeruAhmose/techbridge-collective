        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16 lg:h-[72px]">
            ...
            <div className="flex items-center gap-3 cursor-pointer group">
              <div className="relative">
                <svg
                  ...
                  viewBox="0 0 36 36"
                  fill="none"
                  className="transition-all duration-500 group-hover:scale-110 group-hover:drop-shadow-[0_0_12px_rgba(232,185,49,0.5)]"
                >
                  <path
                    d="M4 26 Q18 8 32 26"
                    stroke="#E8B931"
              ...
              <div className="flex flex-col leading-none">
                ...
                <span
                  className="hidden sm:block font-display text-[10px] font-semibold tracking-[0.3em] uppercase"
          ...
          <div className="hidden lg:flex items-center gap-0.5">
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div
                        ...
                        style={{
                          background:
                            "linear-gradient(90deg, #00D4AA, #E8B931)",
            ...
            <Link href="/get-help" onClick={handleNavClick}>
              <span
                className="ml-2 px-3 py-2 text-sm font-medium rounded-lg flex items-center gap-1.5 cursor-pointer transition-all duration-300 hover:scale-105"
                style={{
            ...
            >
                      ...
                      >
                        {isActive && (
                          <span
                            ...
                            style={{
                              background:
                                "linear-gradient(to bottom, #00D4AA, #E8B931)",
                            }}
                          />
                        )}
                        {item.label}
              ...
              >
                <Link href="/get-help" onClick={() => setMobileOpen(false)}>
                  <span
                    className="block text-center py-4 rounded-xl text-base font-display font-bold cursor-pointer transition-all hover:scale-[1.02]"
                    style={{
                      background: "rgba(0, 212, 170, 0.1)",
                      color: "#00D4AA",
                      border: "1px solid rgba(0, 212, 170, 0.3)",
