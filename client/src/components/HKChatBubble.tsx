...
const HK_BUBBLE_ICON =
  "https://d2xsxph8kpxj0f.cloudfront.net/310419663029216973/6A6PRiSc2SBdMKdQGVopRa/HK_bubble_icon_512_21e73e43.png";
...
const QUICK_ACTIONS = [
  ...
  },
  {
    ...
    query: "I need help applying for jobs online",
  },
  {
    emoji: "📱",
  ...
  },
  {
    ...
    query: "I need help uploading documents online",
  },
  {
    emoji: "🔑",
    label: "Reset a password",
    query: "I need help resetting a password safely",
  },
  {
    emoji: "🏥",
    label: "Set up telehealth",
    query: "I need help setting up a telehealth appointment",
  },
];
        ...
        {isOpen && (
          <motion.div
            ...
            style={{
              ...
              boxShadow:
                "0 20px 60px rgba(0,0,0,0.4), 0 0 40px rgba(201, 162, 39, 0.1)",
          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{ background: "#22c55e", border: "2px solid #0F2B1F" }}
                />
              </div>
              ...
              <div className="flex items-center gap-1">
                ...
                <div
                  ...
                  style={{ background: "#C9A227", animationDelay: "0.2s" }}
                />
                <div
                  className="w-1.5 h-2.5 rounded-full animate-pulse"
                  style={{ background: "#C9A227", animationDelay: "0.4s" }}
                />
              </div>
            </div>
            ...
            >
              <p
                ...
                style={{ color: "rgba(253, 248, 240, 0.4)" }}
              >
                🔒 <strong>Safety:</strong> H.K. never asks for passwords, SSNs,
                bank info, or 2FA codes.
              </p>
            </div>
