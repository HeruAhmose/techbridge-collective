...
export default function Footer() {
  return (
    <footer style={{ background: 'var(--tb-forest)' }}>
      ...
      <div className="relative py-16 overflow-hidden" style={{ background: 'linear-gradient(135deg, var(--tb-forest-light), var(--tb-forest))' }}>
        {/* Circuit background */}
        <div className="absolute inset-0 pointer-events-none" style={{ opacity: 0.04 }}>
          <svg className="w-full h-full" viewBox="0 0 800 200" preserveAspectRatio="xMidYMid slice">
            <path d="M0 100 H200 V50 H400 V150 H600 V100 H800" stroke="#E8B931" strokeWidth="1" fill="none" opacity="0.5" />
            <path d="M0 150 H150 V100 H350 V50 H550 V150 H800" stroke="#00D4AA" strokeWidth="1" fill="none" opacity="0.3" />
            {[{x:200,y:100},{x:400,y:50},{x:600,y:100},{x:150,y:150},{x:350,y:100},{x:550,y:50}].map((p, i) => (
              <circle key={i} cx={p.x} cy={p.y} r="3" fill="#E8B931" opacity="0.4" />
            ))}
          </svg>
        </div>
        ...
        <div className="container relative z-10 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-display text-2xl md:text-4xl font-bold mb-4" style={{ color: 'var(--tb-cream)' }}>
              Ready to bring a hub to <span className="text-glow-gold">your community</span>?
            </h2>
            <p className="text-sm mb-8 max-w-lg mx-auto" style={{ color: 'rgba(253, 248, 240, 0.5)' }}>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex items-center gap-3 group">
              <svg width="32" height="32" viewBox="0 0 36 36" fill="none" className="transition-all duration-500 group-hover:drop-shadow-[0_0_12px_rgba(232,185,49,0.5)]">
              ...
              <span className="font-display text-base font-bold text-glow-gold">TechBridge Collective</span>
            </div>
            ...
            <div className="text-center md:text-right">
              <a href="https://techbridge-collective.org" className="text-sm transition-all duration-300 hover:text-[#E8B931]" style={{ color: 'rgba(253, 248, 240, 0.5)' }}>
                techbridge-collective.org
              </a>
            </div>
          </div>

          <div className="mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4" style={{ borderTop: '1px solid rgba(232, 185, 49, 0.08)' }}>
            ...
            <p className="text-xs font-mono" style={{ color: 'rgba(0, 212, 170, 0.3)' }}>
