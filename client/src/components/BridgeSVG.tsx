...
export default function BridgeSVG({
  ...
  return (
    <svg
      ...
      style={{
        filter: `drop-shadow(0 4px 20px rgba(27, 67, 50, ${0.1 + glowOpacity * 0.15}))`,
      }}
    >
      <defs>
      ...
      <rect
        ...
        height="40"
        fill="#1B4332"
        opacity={foundationOpacity * 0.15}
        rx="2"
      />
      ...
      <g opacity={foundationOpacity}>
        <path
          d="M0 200 L0 260 L180 260 L180 220 Q180 200 160 200 Z"
          fill="url(#bridgeForest)"
        />
      ...
      <g opacity={foundationOpacity}>
        <path
          d="M1200 200 L1200 260 L1020 260 L1020 220 Q1020 200 1040 200 Z"
          fill="url(#bridgeForest)"
        />
      ...
      <g opacity={cableProgress}>
        {[280, 380, 480, 580, 680, 780, 880].map((x, i) => {
          const archY =
            220 - Math.sin(((x - 180) / 840) * Math.PI) * 100 * archProgress;
          const delay = i * 0.08;
          const individualProgress = Math.max(
            0,
            Math.min(1, (cableProgress - delay) * 3)
          );
          return (
