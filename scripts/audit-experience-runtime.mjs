...
try {
  ...
  if (initial.probe.contexts !== 0 || initial.probe.oscillators !== 0) throw new Error(`audio initialized before opt-in: ${JSON.stringify(initial.probe)}`);
  if (!initial.favicon || !initial.favicon.endsWith("/favicon.svg")) throw new Error(`favicon binding missing: ${initial.favicon}`);
